...
Most of these come down to network reality or how bible serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

bible rate-limits like any public site. bible already paces
...
Where a surface is gated, bible reads a cookie or token you supply
...
`bible`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bible actually did
